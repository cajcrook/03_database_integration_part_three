...
We get a list of Albums reflecting the data"""
...
"""
When we call AbumRepository#find
...
def test_create_record(db_connection):
    db_connection.seed("seeds/music_library.sql")
    repository = AlbumRepository(db_connection)
    repository.create(Album(13, "Aha Shake Heartbreak", 2004, 5))
    ...
    assert result == [
        ...
        Album(11, 'Fodder on My Wings', 1982, 4),
        Album(12, 'Ring Ring', 1973, 2),
        Album(13, "Aha Shake Heartbreak", 2004, 5)
    ]
